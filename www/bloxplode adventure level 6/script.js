...
// --- RESTORED: RED COLOR ---
const BLOCK_COLOR = '#FF4444'; 

const SHAPES = {
    DOT:    { data: [[0,0]], color: BLOCK_COLOR },
    I2:     { data: [[0,0],[1,0]], color: BLOCK_COLOR },
    I3:     { data: [[0,0],[1,0],[2,0]], color: BLOCK_COLOR },
    I4:     { data: [[0,0],[1,0],[2,0],[3,0]], color: BLOCK_COLOR },
    O2:     { data: [[0,0],[1,0],[0,1],[1,1]], color: BLOCK_COLOR },
    T:      { data: [[0,1],[1,0],[1,1],[2,1]], color: BLOCK_COLOR },
    PLUS:   { data: [[1,0],[0,1],[1,1],[2,1],[1,2]], color: BLOCK_COLOR },
    I2_V:   { data: [[0,0],[0,1]], color: BLOCK_COLOR },
    I3_V:   { data: [[0,0],[0,1],[0,2]], color: BLOCK_COLOR },
    CORNER: { data: [[0,0],[1,0],[0,1]], color: BLOCK_COLOR },
    L_LEFT: { data: [[0,0],[0,1],[0,2],[1,2]], color: BLOCK_COLOR },
    SKEW:   { data: [[1,0],[2,0],[0,1],[1,1]], color: BLOCK_COLOR }
};
...
function loadLevel() {
    ...
    levelGoals = { gold: 18, purple: 18 };
    
    // Uses the RESTORED map defined at the top
...
function init() {
    ...
    // --- TRIGGER VISUAL PIPE SEQUENCE (START BANNER) ---
...
if (nextBtn) {
    // WINNER: Go to Level 7
    nextBtn.onclick = () => window.location.href = "../bloxplode%20adventure%20level%207/index.html";
}
